...
function Layout({ children }) {
  ...
  return html`
    <div class="app-layout">
      ...
      <!-- Notifications -->
      ${notifications.value.map(notification => html`
        <div 
    ...
    <div class="card">
      ...
      <form ...${form.bind()} @submit=${(e) => {
        ...
        <div class="form-group">
          ...
          />
          ${form.getField('name').error.value && html`
        ...
        <div class="form-group">
          ...
          />
          ${form.getField('email').error.value && html`
        ...
        <div class="form-group">
          ...
          />
          ${form.getField('password').error.value && html`
            <div class="error-message" role="alert">
        ...
        <div class="form-group">
          ...
          />
          ${form.getField('confirmPassword').error.value && html`
            <div class="error-message" role="alert">
        ...
        <div class="form-group">
          ...
          />
          ${form.getField('age').error.value && html`
            <div class="error-message" role="alert">
        ...
        <div class="form-group">
          ...
          ></textarea>
          ${form.getField('bio').error.value && html`
            <div class="error-message" role="alert">
...
export function About() {
  return html`
    <div class="card">
      <h1>About</h1>
      <p>
        This is a complete example of the Berryact framework showcasing:
      </p>
      <ul>
      ...
      <p>
        The entire framework is under 15KB gzipped while providing a 
        comprehensive set of features for building modern web applications.
      </p>
    </div>
  `;
}
