...
export class SpringAnimation {
  ...
  tick() {
    ...
    Object.keys(this.targetValues).forEach(prop => {
      ...
      // Check if settled
      if (Math.abs(displacement) > this.options.precision || 
...
export const Animations = {
  fadeIn: (element, options = {}) => new Animation(element, [
    { opacity: 0 },
    { opacity: 1 }
  ], { duration: 300, ...options }),

  fadeOut: (element, options = {}) => new Animation(element, [
    { opacity: 1 },
    { opacity: 0 }
  ], { duration: 300, ...options }),

  slideInLeft: (element, options = {}) => new Animation(element, [
    { transform: 'translateX(-100%)', opacity: 0 },
    { transform: 'translateX(0)', opacity: 1 }
  ], { duration: 300, easing: 'ease-out', ...options }),

  slideInRight: (element, options = {}) => new Animation(element, [
    { transform: 'translateX(100%)', opacity: 0 },
    { transform: 'translateX(0)', opacity: 1 }
  ], { duration: 300, easing: 'ease-out', ...options }),

  slideInUp: (element, options = {}) => new Animation(element, [
    { transform: 'translateY(100%)', opacity: 0 },
    { transform: 'translateY(0)', opacity: 1 }
  ], { duration: 300, easing: 'ease-out', ...options }),

  slideInDown: (element, options = {}) => new Animation(element, [
    { transform: 'translateY(-100%)', opacity: 0 },
    { transform: 'translateY(0)', opacity: 1 }
  ], { duration: 300, easing: 'ease-out', ...options }),

  scaleIn: (element, options = {}) => new Animation(element, [
    { transform: 'scale(0)', opacity: 0 },
    { transform: 'scale(1)', opacity: 1 }
  ], { duration: 300, easing: 'ease-out', ...options }),

  scaleOut: (element, options = {}) => new Animation(element, [
    { transform: 'scale(1)', opacity: 1 },
    { transform: 'scale(0)', opacity: 0 }
  ], { duration: 300, easing: 'ease-in', ...options }),

  bounce: (element, options = {}) => new Animation(element, [
  ...
  shake: (element, options = {}) => new Animation(element, [
  ...
  pulse: (element, options = {}) => new Animation(element, [
    { transform: 'scale(1)' },
    { transform: 'scale(1.05)' },
    { transform: 'scale(1)' }
  ], { duration: 500, iterations: Infinity, ...options }),

  rotate: (element, options = {}) => new Animation(element, [
    { transform: 'rotate(0deg)' },
    { transform: 'rotate(360deg)' }
  ], { duration: 1000, iterations: Infinity, easing: 'linear', ...options })
};
