...
export function signal(initialValue, options = {}) {
  ...
  if (pluginContext) {
    pluginContext.callHook('global:signal:created', { id: sig.id, value: initialValue, name: sig.name });
  }
...
export function isSignal(value) {
  return value && typeof value === 'object' && 'value' in value && 'peek' in value && '_id' in value;
}
